...
- **Super AI**:똑똑กว่ามนุษย์ในทุกด้าน (เป็นแนวคิดเชิงทฤษฎี)
...
RAG คือสถาปัตยกรรมที่เพิ่มความสามารถของ LLM โดยดึงข้อมูลที่เกี่ยวข้องจากแหล่งข้อมูลภายนอกก่อนสร้างคำตอบ แก้ปัญหา hallucination และข้อมูลหมดอายุ
